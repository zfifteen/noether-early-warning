# Early-Warning Findings Report

## Hypothesis

The working hypothesis is that, in gradual symmetry-breaking regimes, a drift observable can become detectable before a direct symmetry observable does, and that this earlier drift signal can be practically useful as an early warning.

## Core Claims

The validated claim package has four parts:
...
Across the consolidated `B1`-`B4` suite, every benchmark returned `SUPPORTED`. In this repository’s benchmarked paired-MLP regime, the evidence supports the conclusion that drift is an earlier and practically useful warning signal for gradual symmetry breaking.
...
![B1 representative timeseries](./findings_assets/b1_representative_timeseries.png)
...
![B1 onset ordering](./findings_assets/b1_onset_ordering.png)
...
![B2 representative timeseries](./findings_assets/b2_representative_timeseries.png)
...
![B2 onset ordering](./findings_assets/b2_onset_ordering.png)
...
![B3 representative timeseries](./findings_assets/b3_representative_timeseries.png)
...
![B3 onset ordering](./findings_assets/b3_onset_ordering.png)
...
![B4 representative timeseries](./findings_assets/b4_representative_timeseries.png)
...
![B4 onset ordering](./findings_assets/b4_onset_ordering.png)
